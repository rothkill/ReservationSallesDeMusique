...
public class MainTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(UtilisateurDAO.getInstance().rechercher(
				idUtilisateurRecherche));

		System.out.println("Supprimer utilisateur : idUtilisateur ");
		int idUtilisateurSup = sc.nextInt();
		System.out.println(UtilisateurDAO.getInstance().supprimer(
				idUtilisateurSup));
		...
		//
		// CategorieDAO.getInstance().creer(idCategorie, nom, tarifUneHeure,
		// tarifDeuxHeures, npPersonne);
		//
		...
		// try {
		// dateReservation = new
		// SimpleDateFormat("dd.MM.yyyy").parse(resultDateReserv);
		...
		// try {
		// dateFinReservation = new
		// SimpleDateFormat("dd.MM.yyyy").parse(resultDateFinReserv);
		// } catch (ParseException e) {
		// e.printStackTrace();
		// } catch (java.text.ParseException e) {
		// // TODO Auto-generated catch block
		...
		//
		// ReservationDAO.getInstance().creer(idCategorie,dateReservation,
		// dateFinReservation,false, idUtilisateur, idSalle);
		//
